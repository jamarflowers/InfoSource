...
// //    https://api.giphy.com/v1/gifs/search?api_key=&q=science&limit=25&offset=0&rating=G&lang=en
// var imageRequest = new XMLHttpRequest();
// var imageUrl = "https://api.giphy.com/v1/gifs/search?api_key=&q="+searchTerm+"&limit=25&offset=0&rating=G&lang=en";
    ...
    Newsrequest.onload = function(){
        ...
        for(count=0;count<=num;count++){
            ...
            //console.log(res.results["0"].multimedia[2].url);
               ...
               // adds background image to content tile.
              // image = res.results[count];
             

              ContentTile.style.backgroundImage = "url('https://media.giphy.com/media/3o6ZthWzyoIzSknltu/giphy.gif')";
